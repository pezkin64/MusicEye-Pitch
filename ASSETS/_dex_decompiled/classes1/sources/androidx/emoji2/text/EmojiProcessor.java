...
final class EmojiProcessor {
    ...
    /* access modifiers changed from: package-private */
    /* JADX WARNING: Code restructure failed: missing block: B:73:0x011b, code lost:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:77:0x0127, code lost:
        return r10;
     */
    /* JADX WARNING: Removed duplicated region for block: B:23:0x0048 A[Catch:{ all -> 0x0128 }] */
    /* JADX WARNING: Removed duplicated region for block: B:28:0x0064 A[Catch:{ all -> 0x0128 }] */
    ...
    public java.lang.CharSequence process(java.lang.CharSequence r10, int r11, int r12, int r13, boolean r14) {
        ...
        L_0x000a:
            ...
            boolean r1 = r10 instanceof android.text.Spannable     // Catch:{ all -> 0x0128 }
            if (r1 == 0) goto L_0x0011
            goto L_0x002c
        L_0x0011:
            boolean r1 = r10 instanceof android.text.Spanned     // Catch:{ all -> 0x0128 }
            if (r1 == 0) goto L_0x002a
            r1 = r10
            android.text.Spanned r1 = (android.text.Spanned) r1     // Catch:{ all -> 0x0128 }
            int r2 = r11 + -1
            int r3 = r12 + 1
            java.lang.Class<androidx.emoji2.text.EmojiSpan> r4 = androidx.emoji2.text.EmojiSpan.class
            int r1 = r1.nextSpanTransition(r2, r3, r4)     // Catch:{ all -> 0x0128 }
            if (r1 > r12) goto L_0x002a
            androidx.emoji2.text.UnprecomputeTextOnModificationSpannable r1 = new androidx.emoji2.text.UnprecomputeTextOnModificationSpannable     // Catch:{ all -> 0x0128 }
            r1.<init>((java.lang.CharSequence) r10)     // Catch:{ all -> 0x0128 }
            goto L_0x0034
        L_0x002a:
            r1 = 0
            goto L_0x0034
        L_0x002c:
            androidx.emoji2.text.UnprecomputeTextOnModificationSpannable r1 = new androidx.emoji2.text.UnprecomputeTextOnModificationSpannable     // Catch:{ all -> 0x0128 }
            r2 = r10
            android.text.Spannable r2 = (android.text.Spannable) r2     // Catch:{ all -> 0x0128 }
            r1.<init>((android.text.Spannable) r2)     // Catch:{ all -> 0x0128 }
        L_0x0034:
            r2 = 0
            if (r1 == 0) goto L_0x0062
            java.lang.Class<androidx.emoji2.text.EmojiSpan> r3 = androidx.emoji2.text.EmojiSpan.class
            java.lang.Object[] r3 = r1.getSpans(r11, r12, r3)     // Catch:{ all -> 0x0128 }
            androidx.emoji2.text.EmojiSpan[] r3 = (androidx.emoji2.text.EmojiSpan[]) r3     // Catch:{ all -> 0x0128 }
            if (r3 == 0) goto L_0x0062
            int r4 = r3.length     // Catch:{ all -> 0x0128 }
            if (r4 <= 0) goto L_0x0062
            int r4 = r3.length     // Catch:{ all -> 0x0128 }
            r5 = r2
        L_0x0046:
            if (r5 >= r4) goto L_0x0062
            r6 = r3[r5]     // Catch:{ all -> 0x0128 }
            int r7 = r1.getSpanStart(r6)     // Catch:{ all -> 0x0128 }
            int r8 = r1.getSpanEnd(r6)     // Catch:{ all -> 0x0128 }
            if (r7 == r12) goto L_0x0057
            r1.removeSpan(r6)     // Catch:{ all -> 0x0128 }
        L_0x0057:
            int r11 = java.lang.Math.min(r7, r11)     // Catch:{ all -> 0x0128 }
            int r12 = java.lang.Math.max(r8, r12)     // Catch:{ all -> 0x0128 }
            int r5 = r5 + 1
            goto L_0x0046
        L_0x0062:
            if (r11 == r12) goto L_0x0124
            int r3 = r10.length()     // Catch:{ all -> 0x0128 }
        ...
        L_0x006c:
            ...
            java.lang.Class<androidx.emoji2.text.EmojiSpan> r4 = androidx.emoji2.text.EmojiSpan.class
            java.lang.Object[] r3 = r1.getSpans(r2, r3, r4)     // Catch:{ all -> 0x0128 }
            androidx.emoji2.text.EmojiSpan[] r3 = (androidx.emoji2.text.EmojiSpan[]) r3     // Catch:{ all -> 0x0128 }
            int r3 = r3.length     // Catch:{ all -> 0x0128 }
            int r13 = r13 - r3
        L_0x0081:
            androidx.emoji2.text.EmojiProcessor$ProcessorSm r3 = new androidx.emoji2.text.EmojiProcessor$ProcessorSm     // Catch:{ all -> 0x0128 }
            androidx.emoji2.text.MetadataRepo r4 = r9.mMetadataRepo     // Catch:{ all -> 0x0128 }
            androidx.emoji2.text.MetadataRepo$Node r4 = r4.getRootNode()     // Catch:{ all -> 0x0128 }
            boolean r5 = r9.mUseEmojiAsDefaultStyle     // Catch:{ all -> 0x0128 }
            int[] r6 = r9.mEmojiAsDefaultStyleExceptions     // Catch:{ all -> 0x0128 }
            r3.<init>(r4, r5, r6)     // Catch:{ all -> 0x0128 }
            int r4 = java.lang.Character.codePointAt(r10, r11)     // Catch:{ all -> 0x0128 }
            r5 = r4
            r4 = r2
            r2 = r1
        L_0x0097:
        ...
        L_0x0098:
            ...
            int r6 = r3.check(r5)     // Catch:{ all -> 0x0128 }
            r7 = 1
        ...
        L_0x00aa:
            ...
            androidx.emoji2.text.EmojiMetadata r6 = r3.getFlushMetadata()     // Catch:{ all -> 0x0128 }
            boolean r6 = r9.hasGlyph(r10, r1, r11, r6)     // Catch:{ all -> 0x0128 }
            if (r6 != 0) goto L_0x0097
        L_0x00b6:
            if (r2 != 0) goto L_0x00c2
            androidx.emoji2.text.UnprecomputeTextOnModificationSpannable r2 = new androidx.emoji2.text.UnprecomputeTextOnModificationSpannable     // Catch:{ all -> 0x0128 }
            android.text.SpannableString r6 = new android.text.SpannableString     // Catch:{ all -> 0x0128 }
            r6.<init>(r10)     // Catch:{ all -> 0x0128 }
            r2.<init>((android.text.Spannable) r6)     // Catch:{ all -> 0x0128 }
        L_0x00c2:
            androidx.emoji2.text.EmojiMetadata r6 = r3.getFlushMetadata()     // Catch:{ all -> 0x0128 }
            r9.addEmoji(r2, r6, r1, r11)     // Catch:{ all -> 0x0128 }
            int r4 = r4 + 1
            goto L_0x0097
        L_0x00cc:
            int r6 = java.lang.Character.charCount(r5)     // Catch:{ all -> 0x0128 }
            int r11 = r11 + r6
            if (r11 >= r12) goto L_0x0098
            int r5 = java.lang.Character.codePointAt(r10, r11)     // Catch:{ all -> 0x0128 }
            goto L_0x0098
        L_0x00d8:
            int r11 = java.lang.Character.codePointAt(r10, r1)     // Catch:{ all -> 0x0128 }
            int r11 = java.lang.Character.charCount(r11)     // Catch:{ all -> 0x0128 }
            int r1 = r1 + r11
        ...
        L_0x00e8:
            ...
            goto L_0x0098
        L_0x00ea:
            boolean r12 = r3.isInFlushableState()     // Catch:{ all -> 0x0128 }
            if (r12 == 0) goto L_0x010d
            if (r4 >= r13) goto L_0x010d
            if (r14 != 0) goto L_0x00fe
            androidx.emoji2.text.EmojiMetadata r12 = r3.getCurrentMetadata()     // Catch:{ all -> 0x0128 }
            boolean r12 = r9.hasGlyph(r10, r1, r11, r12)     // Catch:{ all -> 0x0128 }
            if (r12 != 0) goto L_0x010d
        L_0x00fe:
            if (r2 != 0) goto L_0x0106
            androidx.emoji2.text.UnprecomputeTextOnModificationSpannable r12 = new androidx.emoji2.text.UnprecomputeTextOnModificationSpannable     // Catch:{ all -> 0x0128 }
            r12.<init>((java.lang.CharSequence) r10)     // Catch:{ all -> 0x0128 }
            r2 = r12
        L_0x0106:
            androidx.emoji2.text.EmojiMetadata r12 = r3.getCurrentMetadata()     // Catch:{ all -> 0x0128 }
            r9.addEmoji(r2, r12, r1, r11)     // Catch:{ all -> 0x0128 }
        L_0x010d:
            if (r2 == 0) goto L_0x011b
            android.text.Spannable r11 = r2.getUnwrappedSpannable()     // Catch:{ all -> 0x0128 }
