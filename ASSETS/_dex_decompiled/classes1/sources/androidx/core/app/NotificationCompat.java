...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r12, int r13, boolean r14) {
            ...
            L_0x0112:
                ...
                androidx.core.app.NotificationCompat.Style.Api16Impl.setTextViewTextSize(r1, r0, r7, r14)
            L_0x0143:
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            z = Api20Impl.getExtras(action2).getBoolean("android.support.allowGeneratedReplies") || Api24Impl.getAllowGeneratedReplies(action2);
        } else {
            z = Api20Impl.getExtras(action2).getBoolean("android.support.allowGeneratedReplies");
        }
        boolean z3 = z;
        boolean z4 = Api20Impl.getExtras(action2).getBoolean("android.support.action.showsUserInterface", true);
        if (Build.VERSION.SDK_INT >= 28) {
        ...
        if (Build.VERSION.SDK_INT >= 31) {
            z2 = Api31Impl.isAuthenticationRequired(action2);
        }
        boolean z5 = z2;
        if (Api23Impl.getIcon(action2) == null && action2.icon != 0) {
            return new Action(action2.icon, action2.title, action2.actionIntent, Api20Impl.getExtras(action2), remoteInputArr, (RemoteInput[]) null, z3, i3, z4, isContextual, z5);
        }
        if (Api23Impl.getIcon(action2) != null) {
            iconCompat = IconCompat.createFromIconOrNullIfZeroResId(Api23Impl.getIcon(action2));
        }
        return new Action(iconCompat, action2.title, action2.actionIntent, Api20Impl.getExtras(action2), remoteInputArr, (RemoteInput[]) null, z3, i3, z4, isContextual, z5);
    }
