...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    private int scrollBy(int i, int i2, int i3, boolean z) {
        ...
        int i8 = i7;
        boolean z2 = false;
        if (dispatchNestedPreScroll(0, i, this.mScrollConsumed, this.mScrollOffset, i7)) {
        ...
        int i10 = scrollY;
        int i11 = scrollRange;
        boolean z4 = overScrollByCompat(0, i5, 0, scrollY, 0, scrollRange, 0, 0, true) && !hasNestedScrollingParent(i8);
        int scrollY2 = getScrollY() - i10;
        int[] iArr = this.mScrollConsumed;
        iArr[1] = 0;
        int i12 = i8;
        dispatchNestedScroll(0, scrollY2, 0, i9 - scrollY2, this.mScrollOffset, i12, iArr);
        int i13 = i12;
        int i14 = i4 + this.mScrollOffset[1];
        int i15 = i9 - this.mScrollConsumed[1];
        int i16 = i10 + i15;
        if (i16 < 0) {
            if (z3) {
                EdgeEffectCompat.onPullDistance(this.mEdgeGlowTop, ((float) (-i15)) / ((float) getHeight()), ((float) i6) / ((float) getWidth()));
                if (!this.mEdgeGlowBottom.isFinished()) {
                    this.mEdgeGlowBottom.onRelease();
                }
            }
        } else if (i16 > i11 && z3) {
            EdgeEffectCompat.onPullDistance(this.mEdgeGlowBottom, ((float) i15) / ((float) getHeight()), 1.0f - (((float) i6) / ((float) getWidth())));
