...
public class ShortcutManagerCompat {
    ...
    public static boolean isRequestPinShortcutSupported(android.content.Context r4) {
        /*
            ...
            java.lang.Class r0 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2()
            java.lang.Object r4 = r4.getSystemService(r0)
            android.content.pm.ShortcutManager r4 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r4)
            boolean r4 = androidx.core.util.HalfKt$$ExternalSyntheticApiModelOutline0.m((android.content.pm.ShortcutManager) r4)
            return r4
        L_0x0017:
    ...
    public static boolean requestPinShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat, final IntentSender intentSender) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return ComponentDialog$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).requestPinShortcut(shortcutInfoCompat.toShortcutInfo(), intentSender);
        }
    ...
    public static Intent createShortcutResultIntent(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        Intent m = Build.VERSION.SDK_INT >= 26 ? ComponentDialog$$ExternalSyntheticApiModelOutline0.m(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())), shortcutInfoCompat.toShortcutInfo()) : null;
        if (m == null) {
            m = new Intent();
        }
    ...
    public static List<ShortcutInfoCompat> getShortcuts(Context context, int i) {
        if (Build.VERSION.SDK_INT >= 30) {
            return ShortcutInfoCompat.fromShortcuts(context, ComponentDialog$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).getShortcuts(i));
        }
        if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManager m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2()));
            ArrayList arrayList = new ArrayList();
            if ((i & 1) != 0) {
                arrayList.addAll(HalfKt$$ExternalSyntheticApiModelOutline0.m(m));
            }
            if ((i & 2) != 0) {
                arrayList.addAll(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(m));
            }
            if ((i & 4) != 0) {
    ...
    public static boolean addDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!ComponentDialog$$ExternalSyntheticApiModelOutline0.m$1(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())), (List) arrayList)) {
                return false;
            }
        }
    ...
    public static int getMaxShortcutCountPerActivity(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            return ComponentDialog$$ExternalSyntheticApiModelOutline0.m(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())));
        }
        return 5;
    }
    ...
    public static int getIconMaxWidth(Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return ComponentDialog$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).getIconMaxWidth();
        }
    ...
    public static int getIconMaxHeight(Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return ComponentDialog$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).getIconMaxHeight();
        }
    ...
    public static void reportShortcutUsed(Context context, String str) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ComponentDialog$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).reportShortcutUsed(str);
        }
    ...
    public static boolean setDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!ComponentDialog$$ExternalSyntheticApiModelOutline0.m(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())), (List) arrayList)) {
                return false;
            }
        }
    ...
    public static List<ShortcutInfoCompat> getDynamicShortcuts(Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            List<Object> m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())));
    ...
    public static boolean updateShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!ComponentDialog$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).updateShortcuts(arrayList)) {
                return false;
            }
        }
        getShortcutInfoSaverInstance(context).addShortcuts(removeShortcutsExcludedFromSurface);
    ...
    public static void disableShortcuts(Context context, List<String> list, CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 25) {
            ComponentDialog$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).disableShortcuts(list, charSequence);
        }
    ...
    public static void enableShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            ComponentDialog$$ExternalSyntheticApiModelOutline0.m(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())), (List) arrayList);
        }
        getShortcutInfoSaverInstance(context).addShortcuts(removeShortcutsExcludedFromSurface);
        for (ShortcutInfoChangeListener onShortcutAdded : getShortcutInfoListeners(context)) {
            onShortcutAdded.onShortcutAdded(list);
    ...
    public static void removeDynamicShortcuts(Context context, List<String> list) {
        if (Build.VERSION.SDK_INT >= 25) {
            ComponentDialog$$ExternalSyntheticApiModelOutline0.m$1(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())), (List) list);
        }
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        for (ShortcutInfoChangeListener onShortcutRemoved : getShortcutInfoListeners(context)) {
            onShortcutRemoved.onShortcutRemoved(list);
    ...
    public static void removeAllDynamicShortcuts(Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            HalfKt$$ExternalSyntheticApiModelOutline0.m(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())));
        }
        getShortcutInfoSaverInstance(context).removeAllShortcuts();
    ...
    public static void removeLongLivedShortcuts(Context context, List<String> list) {
        ...
        ComponentDialog$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).removeLongLivedShortcuts(list);
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        for (ShortcutInfoChangeListener onShortcutRemoved : getShortcutInfoListeners(context)) {
            onShortcutRemoved.onShortcutRemoved(list);
        }
    ...
    public static boolean pushDynamicShortcut(android.content.Context r6, androidx.core.content.pm.ShortcutInfoCompat r7) {
        ...
        L_0x0041:
            ...
            java.lang.Class r3 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2()
            java.lang.Object r3 = r6.getSystemService(r3)
            android.content.pm.ShortcutManager r3 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r3)
            android.content.pm.ShortcutInfo r4 = r7.toShortcutInfo()
            androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m((android.content.pm.ShortcutManager) r3, (android.content.pm.ShortcutInfo) r4)
            goto L_0x009c
        L_0x005b:
            int r3 = android.os.Build.VERSION.SDK_INT
            r4 = 25
            ...
            java.lang.Object r3 = r6.getSystemService(r3)
            android.content.pm.ShortcutManager r3 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r3)
            boolean r4 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m((android.content.pm.ShortcutManager) r3)
            if (r4 == 0) goto L_0x0074
            return r1
        L_0x0074:
            java.util.List r4 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m((android.content.pm.ShortcutManager) r3)
            int r5 = r4.size()
            ...
            androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m$1((android.content.pm.ShortcutManager) r3, (java.util.List) r4)
        L_0x008d:
