...
public class IntentSanitizer {
    ...
    public Intent sanitize(Intent intent, Consumer<String> consumer) {
        ...
        Api16Impl.sanitizeClipData(intent3, intent2, this.mAllowedClipData, this.mAllowClipDataText, this.mAllowedClipDataUri, consumer2);
        ...
        if (this.mAllowSelector) {
            Api15Impl.setSelector(intent2, Api15Impl.getSelector(intent3));
        } else if (Api15Impl.getSelector(intent3) != null) {
            consumer2.accept("Selector is not allowed: " + Api15Impl.getSelector(intent3));
        }
