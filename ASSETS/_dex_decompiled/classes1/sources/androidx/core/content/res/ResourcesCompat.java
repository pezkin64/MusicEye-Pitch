...
public final class ResourcesCompat {
    ...
    private static android.graphics.Typeface loadFont(android.content.Context r13, android.content.res.Resources r14, android.util.TypedValue r15, int r16, int r17, androidx.core.content.res.ResourcesCompat.FontCallback r18, android.os.Handler r19, boolean r20, boolean r21) {
        ...
        L_0x0032:
            ...
            return r12
        L_0x0035:
            java.lang.String r0 = r3.toLowerCase()     // Catch:{ XmlPullParserException -> 0x0097, IOException -> 0x0083 }
            java.lang.String r1 = ".xml"
            boolean r0 = r0.endsWith(r1)     // Catch:{ XmlPullParserException -> 0x0097, IOException -> 0x0083 }
            if (r0 == 0) goto L_0x006b
            android.content.res.XmlResourceParser r0 = r14.getXml(r2)     // Catch:{ XmlPullParserException -> 0x0097, IOException -> 0x0083 }
            androidx.core.content.res.FontResourcesParserCompat$FamilyResourceEntry r1 = androidx.core.content.res.FontResourcesParserCompat.parse(r0, r14)     // Catch:{ XmlPullParserException -> 0x0097, IOException -> 0x0083 }
            if (r1 != 0) goto L_0x0056
            java.lang.String r13 = "Failed to find font-family tag"
            android.util.Log.e(r10, r13)     // Catch:{ XmlPullParserException -> 0x0097, IOException -> 0x0083 }
            if (r7 == 0) goto L_0x0055
            r7.callbackFailAsync(r11, r8)     // Catch:{ XmlPullParserException -> 0x0097, IOException -> 0x0083 }
        L_0x0055:
            return r12
        L_0x0056:
            int r5 = r15.assetCookie     // Catch:{ XmlPullParserException -> 0x0097, IOException -> 0x0083 }
            r0 = r13
            r6 = r17
            r9 = r20
            r4 = r3
        ...
        L_0x0068:
            ...
            goto L_0x0098
        L_0x006b:
            int r4 = r15.assetCookie     // Catch:{ XmlPullParserException -> 0x0097, IOException -> 0x0083 }
            r0 = r13
            r1 = r14
            r2 = r16
            r5 = r17
            android.graphics.Typeface r13 = androidx.core.graphics.TypefaceCompat.createFromResourcesFontFile(r0, r1, r2, r3, r4, r5)     // Catch:{ XmlPullParserException -> 0x0097, IOException -> 0x0083 }
            if (r7 == 0) goto L_0x0082
            if (r13 == 0) goto L_0x007f
            r7.callbackSuccessAsync(r13, r8)     // Catch:{ XmlPullParserException -> 0x0097, IOException -> 0x0083 }
            return r13
        L_0x007f:
            r7.callbackFailAsync(r11, r8)     // Catch:{ XmlPullParserException -> 0x0097, IOException -> 0x0083 }
        L_0x0082:
