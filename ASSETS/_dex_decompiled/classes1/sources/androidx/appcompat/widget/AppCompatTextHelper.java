...
class AppCompatTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        ViewCompat.saveAttributeDataForStyleable(textView, textView.getContext(), R.styleable.AppCompatTextHelper, attributeSet2, obtainStyledAttributes.getWrappedTypeArray(), i2, 0);
