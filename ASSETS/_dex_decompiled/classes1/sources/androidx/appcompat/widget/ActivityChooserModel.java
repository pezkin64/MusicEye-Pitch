...
class ActivityChooserModel extends DataSetObservable {
    ...
    private void readHistoricalDataImpl() {
        /*
            ...
            org.xmlpull.v1.XmlPullParser r2 = android.util.Xml.newPullParser()     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
            java.lang.String r3 = "UTF-8"
            r2.setInput(r1, r3)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
            r3 = 0
        L_0x0014:
            r4 = 1
            ...
            int r3 = r2.next()     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
            goto L_0x0014
        L_0x001f:
            java.lang.String r3 = "historical-records"
            java.lang.String r5 = r2.getName()     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
            boolean r3 = r3.equals(r5)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
            if (r3 == 0) goto L_0x007b
            java.util.List<androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord> r3 = r10.mHistoricalRecords     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
            r3.clear()     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
        L_0x0030:
            int r5 = r2.next()     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
        ...
        L_0x0043:
            ...
            boolean r5 = r6.equals(r5)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
            if (r5 == 0) goto L_0x0073
            java.lang.String r5 = "activity"
            r6 = 0
            java.lang.String r5 = r2.getAttributeValue(r6, r5)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
            java.lang.String r7 = "time"
            java.lang.String r7 = r2.getAttributeValue(r6, r7)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
            long r7 = java.lang.Long.parseLong(r7)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
            java.lang.String r9 = "weight"
            java.lang.String r6 = r2.getAttributeValue(r6, r9)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
            float r6 = java.lang.Float.parseFloat(r6)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
            androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord r9 = new androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
            r9.<init>((java.lang.String) r5, (long) r7, (float) r6)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
            r3.add(r9)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
            goto L_0x0030
        L_0x0073:
            org.xmlpull.v1.XmlPullParserException r2 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
            java.lang.String r3 = "Share records file not well-formed."
            r2.<init>(r3)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
            throw r2     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
        L_0x007b:
            org.xmlpull.v1.XmlPullParserException r2 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x0085 }
