...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl {
        ...
        public BrowserRoot onGetRoot(String str, int i, Bundle bundle) {
            ...
            ConnectionRecord connectionRecord = new ConnectionRecord(str2, i2, i3, bundle3, (ServiceCallbacks) null);
            MediaBrowserServiceCompat.this.mCurConnection = connectionRecord;
            BrowserRoot onGetRoot = MediaBrowserServiceCompat.this.onGetRoot(str2, i3, bundle3);
        ...
        public void registerCallbacks(ServiceCallbacks serviceCallbacks, String str, int i, int i2, Bundle bundle) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                public void run() {
                    ...
                    if (connectionRecord == null) {
                        connectionRecord = new ConnectionRecord(str2, i3, i4, bundle2, serviceCallbacks2);
                    }
                    MediaBrowserServiceCompat.this.mConnections.put(asBinder, connectionRecord);
                    try {
                        asBinder.linkToDeath(connectionRecord, 0);
    ...
    public void performLoadChildren(String str, ConnectionRecord connectionRecord, Bundle bundle, Bundle bundle2) {
        ...
        AnonymousClass1 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str3) {
            /* access modifiers changed from: package-private */
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
        ...
        if (bundle3 == null) {
            onLoadChildren(str3, r0);
        } else {
            onLoadChildren(str3, r0, bundle3);
        }
        this.mCurConnection = null;
        if (!r0.isDone()) {
