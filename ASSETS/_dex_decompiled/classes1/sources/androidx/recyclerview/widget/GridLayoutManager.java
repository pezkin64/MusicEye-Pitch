    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i17 = 0; i17 < i12; i17++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i14) {
                ...
                if (this.mOrientation == 1) {
                    i9 = getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i19, layoutParams.width, false);
                    i8 = View.MeasureSpec.makeMeasureSpec(i14 - i18, BasicMeasure.EXACTLY);
                } else {
                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i14 - i19, BasicMeasure.EXACTLY);
                    i8 = getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i18, layoutParams.height, false);
                    i9 = makeMeasureSpec;
                }
