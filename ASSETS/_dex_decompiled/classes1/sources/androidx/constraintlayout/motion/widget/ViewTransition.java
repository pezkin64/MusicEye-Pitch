...
public class ViewTransition {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x005e, code lost:
        if (r0.equals(CUSTOM_METHOD) != false) goto L_0x0060;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0060, code lost:
        androidx.constraintlayout.widget.ConstraintAttribute.parse(r5, r6, r4.mConstraintDelta.mCustomConstraints);
     */
    ...
    ViewTransition(android.content.Context r5, org.xmlpull.v1.XmlPullParser r6) {
        /*
            ...
            r4.<init>()
            r0 = -1
            r4.mOnStateTransition = r0
            r1 = 0
            r4.mDisabled = r1
            r4.mPathMotionArc = r1
            r4.mDuration = r0
            r4.mUpDuration = r0
            r4.mDefaultInterpolator = r1
            r1 = 0
            r4.mDefaultInterpolatorString = r1
            r4.mDefaultInterpolatorID = r0
            r4.mSetsTag = r0
            r4.mClearsTag = r0
            r4.mIfTagSet = r0
            r4.mIfTagNotSet = r0
            r4.mSharedValueTarget = r0
            r4.mSharedValueID = r0
            r4.mSharedValueCurrent = r0
            r4.mContext = r5
            int r0 = r6.getEventType()     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
        L_0x002a:
            r1 = 1
            ...
            goto L_0x00c8
        L_0x0037:
            java.lang.String r0 = r6.getName()     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            boolean r0 = r2.equals(r0)     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            if (r0 == 0) goto L_0x00c8
            goto L_0x00d7
        L_0x0043:
            java.lang.String r0 = r6.getName()     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            int r1 = r0.hashCode()     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            switch(r1) {
                case -1962203927: goto L_0x0082;
                case -1239391468: goto L_0x0072;
                case 61998586: goto L_0x0068;
                case 366511058: goto L_0x0058;
                case 1791837707: goto L_0x004f;
                default: goto L_0x004e;
            }     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
        L_0x004e:
            goto L_0x0091
        L_0x004f:
            java.lang.String r1 = "CustomAttribute"
            boolean r1 = r0.equals(r1)     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
        ...
        L_0x0058:
            ...
            if (r1 == 0) goto L_0x0091
        L_0x0060:
            androidx.constraintlayout.widget.ConstraintSet$Constraint r0 = r4.mConstraintDelta     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            java.util.HashMap<java.lang.String, androidx.constraintlayout.widget.ConstraintAttribute> r0 = r0.mCustomConstraints     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            androidx.constraintlayout.widget.ConstraintAttribute.parse(r5, r6, r0)     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            goto L_0x00c8
        L_0x0068:
            boolean r1 = r0.equals(r2)     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            if (r1 == 0) goto L_0x0091
            r4.parseViewTransitionTags(r5, r6)     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            goto L_0x00c8
        L_0x0072:
            java.lang.String r1 = "KeyFrameSet"
            boolean r1 = r0.equals(r1)     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            if (r1 == 0) goto L_0x0091
            androidx.constraintlayout.motion.widget.KeyFrames r0 = new androidx.constraintlayout.motion.widget.KeyFrames     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            r0.<init>(r5, r6)     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            r4.mKeyFrames = r0     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            goto L_0x00c8
        L_0x0082:
            java.lang.String r1 = "ConstraintOverride"
            boolean r1 = r0.equals(r1)     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            if (r1 == 0) goto L_0x0091
            androidx.constraintlayout.widget.ConstraintSet$Constraint r0 = androidx.constraintlayout.widget.ConstraintSet.buildDelta(r5, r6)     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            r4.mConstraintDelta = r0     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            goto L_0x00c8
        L_0x0091:
            java.lang.String r1 = TAG     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            r2.<init>()     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            java.lang.String r3 = androidx.constraintlayout.motion.widget.Debug.getLoc()     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            r2.append(r3)     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            java.lang.String r3 = " unknown tag "
            r2.append(r3)     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            r2.append(r0)     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            java.lang.String r0 = r2.toString()     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            android.util.Log.e(r1, r0)     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            java.lang.String r0 = TAG     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            r1.<init>()     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            java.lang.String r2 = ".xml:"
            r1.append(r2)     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            int r2 = r6.getLineNumber()     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            r1.append(r2)     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            java.lang.String r1 = r1.toString()     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            android.util.Log.e(r0, r1)     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
        L_0x00c8:
            int r0 = r6.next()     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00ce }
            goto L_0x002a
        L_0x00ce:
            r5 = move-exception
            r5.printStackTrace()
