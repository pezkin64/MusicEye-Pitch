...
public final class CacheStats {
    ...
    public CacheStats minus(CacheStats cacheStats) {
        ...
        long max = Math.max(0, this.hitCount - cacheStats3.hitCount);
        long max2 = Math.max(0, this.missCount - cacheStats3.missCount);
        long max3 = Math.max(0, this.loadSuccessCount - cacheStats3.loadSuccessCount);
        long max4 = Math.max(0, this.loadExceptionCount - cacheStats3.loadExceptionCount);
        long max5 = Math.max(0, this.totalLoadTime - cacheStats3.totalLoadTime);
        new CacheStats(max, max2, max3, max4, max5, Math.max(0, this.evictionCount - cacheStats3.evictionCount));
        return cacheStats2;
    }
