...
public class TextInputLayout extends LinearLayout {
    ...
    private void updateCursorColor(boolean z) {
        ...
        EditText editText2 = this.editText;
        if (editText2 != null && PathTreeWalk$.ExternalSyntheticApiModelOutline0.m(editText2) != null && colorStateListOrNull != null) {
            Drawable m = PathTreeWalk$.ExternalSyntheticApiModelOutline0.m(this.editText);
            if (z) {
            ...
            DrawableCompat.setTintList(m, colorStateListOrNull);
        }
    }
