        ...
        if (i == 18) {
            ...
            if (PlatformVersion.isAtLeastO()) {
                ...
                if (str2 == null) {
                    ...
                    if (m == null) {
                        notificationManager.createNotificationChannel(Trace$$ExternalSyntheticApiModelOutline0.m(str2, (CharSequence) string, 4));
                    } else if (!string.contentEquals(m.getName())) {
                        m.setName(string);
