...
public final class LockFreeTaskQueueCore<E> {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:20:0x0069 A[LOOP:1: B:20:0x0069->B:23:0x007b, LOOP_START, PHI: r0 
      PHI: (r0v8 kotlinx.coroutines.internal.LockFreeTaskQueueCore) = (r0v7 kotlinx.coroutines.internal.LockFreeTaskQueueCore), (r0v10 kotlinx.coroutines.internal.LockFreeTaskQueueCore) binds: [B:19:0x0061, B:23:0x007b] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public final Object removeFirstOrNull() {
        while (true) {
            ...
            if (obj == null) {
                ...
                if (atomicLongFieldUpdater.compareAndSet(this, j, updateHead)) {
