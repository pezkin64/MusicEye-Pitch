...
public class LockFreeLinkedListNode {
    ...
    public final /* synthetic */ <T> T removeFirstIfIsInstanceOfOrPeekIf(Function1<? super T, Boolean> function1) {
        ...
        while (true) {
            t = (LockFreeLinkedListNode) getNext();
            if (t == this) {
                return null;
            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0047, code lost:
        if (androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper$.ExternalSyntheticBackportWithForwarding0.m(_next$FU, r3, r2, ((kotlinx.coroutines.internal.Removed) r4).ref) != false) goto L_0x004a;
     */
