...
public class ThreadSafeHeap<T extends ThreadSafeHeapNode & Comparable<? super T>> {
    ...
    public final T removeFirstIf(kotlin.jvm.functions.Function1<? super T, java.lang.Boolean> r3) {
        /*
            r2 = this;
            monitor-enter(r2)
            kotlinx.coroutines.internal.ThreadSafeHeapNode r0 = r2.firstImpl()     // Catch:{ all -> 0x0021 }
            r1 = 0
            if (r0 != 0) goto L_0x000a
            monitor-exit(r2)
            return r1
        L_0x000a:
            java.lang.Object r3 = r3.invoke(r0)     // Catch:{ all -> 0x0021 }
            java.lang.Boolean r3 = (java.lang.Boolean) r3     // Catch:{ all -> 0x0021 }
            boolean r3 = r3.booleanValue()     // Catch:{ all -> 0x0021 }
            if (r3 == 0) goto L_0x001c
            r3 = 0
            kotlinx.coroutines.internal.ThreadSafeHeapNode r1 = r2.removeAtImpl(r3)     // Catch:{ all -> 0x0021 }
            goto L_0x001f
        L_0x001c:
            r3 = r1
            kotlinx.coroutines.internal.ThreadSafeHeapNode r3 = (kotlinx.coroutines.internal.ThreadSafeHeapNode) r3     // Catch:{ all -> 0x0021 }
        L_0x001f:
            monitor-exit(r2)
            return r1
        L_0x0021:
