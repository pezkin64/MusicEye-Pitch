...
final class FlowKt__DelayKt$debounceInternal$1 extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARNING: Can't wrap try/catch for region: R(12:7|25|28|(7:36|37|38|(1:40)|41|44|(1:46))(2:34|35)|30|36|37|38|(0)|41|44|(0)) */
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x00b2, code lost:
        if (r9.emit(r10, r14) == r1) goto L_0x0122;
     */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:40:0x00f4 A[Catch:{ all -> 0x010f }] */
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object r15) {
        ...
        L_0x0045:
            ...
            r8 = 0
            r9 = 0
            kotlinx.coroutines.channels.ReceiveChannel r0 = kotlinx.coroutines.channels.ProduceKt.produce$default(r7, r8, r9, r10, r11, r12)
        ...
        L_0x00db:
            ...
            r10.<init>(r15)
            r11 = r10
            kotlinx.coroutines.selects.SelectBuilder r11 = (kotlinx.coroutines.selects.SelectBuilder) r11     // Catch:{ all -> 0x010f }
            T r12 = r7.element     // Catch:{ all -> 0x010f }
            if (r12 == 0) goto L_0x0100
            long r12 = r0.element     // Catch:{ all -> 0x010f }
            kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$3$1 r0 = new kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$3$1     // Catch:{ all -> 0x010f }
            r0.<init>(r9, r7, r6)     // Catch:{ all -> 0x010f }
            kotlin.jvm.functions.Function1 r0 = (kotlin.jvm.functions.Function1) r0     // Catch:{ all -> 0x010f }
            r11.onTimeout(r12, r0)     // Catch:{ all -> 0x010f }
        L_0x0100:
            kotlinx.coroutines.selects.SelectClause1 r0 = r8.getOnReceiveCatching()     // Catch:{ all -> 0x010f }
            kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$3$2 r12 = new kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$3$2     // Catch:{ all -> 0x010f }
            r12.<init>(r7, r9, r6)     // Catch:{ all -> 0x010f }
            kotlin.jvm.functions.Function2 r12 = (kotlin.jvm.functions.Function2) r12     // Catch:{ all -> 0x010f }
            r11.invoke(r0, r12)     // Catch:{ all -> 0x010f }
            goto L_0x0113
        L_0x010f:
            r0 = move-exception
            r10.handleBuilderException(r0)
