    ...
    public final long tryStealBlockingFrom(WorkQueue workQueue) {
        if (!DebugKt.getASSERTIONS_ENABLED() || getBufferSize$kotlinx_coroutines_core() == 0) {
            ...
            while (i != i2) {
                ...
                if (task == null || task.taskContext.getTaskMode() != 1 || !Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceArray, i3, task, (Object) null)) {
                    i++;
                } else {
