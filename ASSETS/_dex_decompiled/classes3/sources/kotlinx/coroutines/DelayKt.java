...
public final class DelayKt {
    ...
    public static final Object m1509delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1510toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1510toDelayMillisLRDsOJo(long j) {
        if (Duration.m1335compareToLRDsOJo(j, Duration.Companion.m1439getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1354getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
