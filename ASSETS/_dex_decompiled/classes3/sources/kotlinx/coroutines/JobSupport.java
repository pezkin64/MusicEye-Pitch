...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:51:0x0080, code lost:
        if (tryWaitForChild(r1, r6, r7) == false) goto L_0x0085;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x0089, code lost:
        return finalizeFinishingState(r1, r7);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final java.lang.Object tryMakeCompletingSlowPath(kotlinx.coroutines.Incomplete r6, java.lang.Object r7) {
        /*
            r5 = this;
            kotlinx.coroutines.NodeList r0 = r5.getOrPromoteCancellingList(r6)
        ...
        L_0x001d:
            monitor-enter(r1)
            boolean r3 = r1.isCompleting()     // Catch:{ all -> 0x008a }
            if (r3 == 0) goto L_0x002a
            kotlinx.coroutines.internal.Symbol r6 = kotlinx.coroutines.JobSupportKt.COMPLETING_ALREADY     // Catch:{ all -> 0x008a }
            monitor-exit(r1)
            return r6
        L_0x002a:
            r3 = 1
            r1.setCompleting(r3)     // Catch:{ all -> 0x008a }
            if (r1 == r6) goto L_0x003e
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r3 = _state$FU     // Catch:{ all -> 0x008a }
            boolean r3 = androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper$.ExternalSyntheticBackportWithForwarding0.m(r3, r5, r6, r1)     // Catch:{ all -> 0x008a }
            if (r3 != 0) goto L_0x003e
            kotlinx.coroutines.internal.Symbol r6 = kotlinx.coroutines.JobSupportKt.COMPLETING_RETRY     // Catch:{ all -> 0x008a }
            monitor-exit(r1)
            return r6
        L_0x003e:
            boolean r3 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch:{ all -> 0x008a }
            if (r3 == 0) goto L_0x0051
            boolean r3 = r1.isSealed()     // Catch:{ all -> 0x008a }
            if (r3 != 0) goto L_0x004b
            goto L_0x0051
        L_0x004b:
            java.lang.AssertionError r6 = new java.lang.AssertionError     // Catch:{ all -> 0x008a }
            r6.<init>()     // Catch:{ all -> 0x008a }
            throw r6     // Catch:{ all -> 0x008a }
        L_0x0051:
            boolean r3 = r1.isCancelling()     // Catch:{ all -> 0x008a }
            boolean r4 = r7 instanceof kotlinx.coroutines.CompletedExceptionally     // Catch:{ all -> 0x008a }
            if (r4 == 0) goto L_0x005d
            r4 = r7
            kotlinx.coroutines.CompletedExceptionally r4 = (kotlinx.coroutines.CompletedExceptionally) r4     // Catch:{ all -> 0x008a }
            goto L_0x005e
        L_0x005d:
            r4 = r2
        L_0x005e:
            ...
            goto L_0x0066
        L_0x0061:
            java.lang.Throwable r4 = r4.cause     // Catch:{ all -> 0x008a }
            r1.addExceptionLocked(r4)     // Catch:{ all -> 0x008a }
        L_0x0066:
            java.lang.Throwable r4 = r1.getRootCause()     // Catch:{ all -> 0x008a }
        ...
        L_0x006d:
            ...
            goto L_0x0076
        L_0x0073:
            r5.notifyCancelling(r0, r2)
        L_0x0076:
            kotlinx.coroutines.ChildHandleNode r6 = r5.firstChild(r6)
            if (r6 == 0) goto L_0x0085
            boolean r6 = r5.tryWaitForChild(r1, r6, r7)
            if (r6 == 0) goto L_0x0085
            kotlinx.coroutines.internal.Symbol r6 = kotlinx.coroutines.JobSupportKt.COMPLETING_WAITING_CHILDREN
            return r6
        L_0x0085:
            java.lang.Object r6 = r5.finalizeFinishingState(r1, r7)
            return r6
        L_0x008a:
            r6 = move-exception
            monitor-exit(r1)
    ...
    private final java.lang.Object makeCancelling(java.lang.Object r7) {
        ...
        L_0x0002:
            ...
            monitor-enter(r2)
            r3 = r2
            kotlinx.coroutines.JobSupport$Finishing r3 = (kotlinx.coroutines.JobSupport.Finishing) r3     // Catch:{ all -> 0x004d }
            boolean r3 = r3.isSealed()     // Catch:{ all -> 0x004d }
            if (r3 == 0) goto L_0x001a
            kotlinx.coroutines.internal.Symbol r7 = kotlinx.coroutines.JobSupportKt.TOO_LATE_TO_CANCEL     // Catch:{ all -> 0x004d }
            monitor-exit(r2)
            return r7
        L_0x001a:
            r3 = r2
            kotlinx.coroutines.JobSupport$Finishing r3 = (kotlinx.coroutines.JobSupport.Finishing) r3     // Catch:{ all -> 0x004d }
            boolean r3 = r3.isCancelling()     // Catch:{ all -> 0x004d }
            if (r7 != 0) goto L_0x0025
            if (r3 != 0) goto L_0x0031
        L_0x0025:
            if (r1 != 0) goto L_0x002b
            java.lang.Throwable r1 = r6.createCauseException(r7)     // Catch:{ all -> 0x004d }
        L_0x002b:
            r7 = r2
            kotlinx.coroutines.JobSupport$Finishing r7 = (kotlinx.coroutines.JobSupport.Finishing) r7     // Catch:{ all -> 0x004d }
            r7.addExceptionLocked(r1)     // Catch:{ all -> 0x004d }
        L_0x0031:
            r7 = r2
            kotlinx.coroutines.JobSupport$Finishing r7 = (kotlinx.coroutines.JobSupport.Finishing) r7     // Catch:{ all -> 0x004d }
            java.lang.Throwable r7 = r7.getRootCause()     // Catch:{ all -> 0x004d }
