...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    public V put(K k, V v) {
        K k2 = k;
        V v2 = v;
        V putImpl$default = Core.putImpl$default((Core) this.core, k2, v2, (HashedWeakRef) null, 4, (Object) null);
    ...
    public V remove(Object obj) {
        ...
        Object obj2 = obj;
        V putImpl$default = Core.putImpl$default((Core) this.core, obj2, (Object) null, (HashedWeakRef) null, 4, (Object) null);
        if (putImpl$default == ConcurrentWeakMapKt.REHASH) {
    ...
    private final synchronized V putSynchronized(K k, V v) {
        ...
        try {
            ...
            while (true) {
                K k2 = k;
                V v2 = v;
                putImpl$default = Core.putImpl$default(core2, k2, v2, (HashedWeakRef) null, 4, (Object) null);
                if (putImpl$default == ConcurrentWeakMapKt.REHASH) {
                    core2 = core2.rehash();
                    this.core = core2;
                    k = k2;
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        if (!(obj2 instanceof Marked)) {
                            if (Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(this.values, i2, obj2, ConcurrentWeakMapKt.mark(obj2))) {
                                break;
                            }
                        } else {
