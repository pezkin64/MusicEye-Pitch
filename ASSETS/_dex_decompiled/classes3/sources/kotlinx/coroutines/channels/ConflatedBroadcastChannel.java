...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    private final Subscriber<E>[] removeSubscriber(Subscriber<E>[] subscriberArr, Subscriber<E> subscriber) {
        ...
        if (DebugKt.getASSERTIONS_ENABLED() && indexOf < 0) {
            ...
            ArraysKt.copyInto$default((Object[]) subscriberArr3, (Object[]) subscriberArr2, 0, 0, i, 6, (Object) null);
            ArraysKt.copyInto$default((Object[]) subscriberArr3, (Object[]) subscriberArr2, i, i + 1, 0, 8, (Object) null);
    ...
    public Object m1544trySendJP2dKIU(E e) {
        Closed offerInternal = offerInternal(e);
        if (offerInternal == null) {
            return ChannelResult.Companion.m1543successJP2dKIU(Unit.INSTANCE);
        }
        return ChannelResult.Companion.m1541closedJP2dKIU(offerInternal.getSendException());
    }
