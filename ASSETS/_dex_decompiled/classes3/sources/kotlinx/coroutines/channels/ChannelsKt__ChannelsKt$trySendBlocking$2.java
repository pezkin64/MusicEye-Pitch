    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m5constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m5constructorimpl(Unit.INSTANCE);
        if (Result.m12isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m1543successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m1541closedJP2dKIU(Result.m8exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m1528boximpl(obj3);
    }
}
