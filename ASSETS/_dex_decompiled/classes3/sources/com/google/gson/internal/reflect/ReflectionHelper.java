...
public class ReflectionHelper {
    ...
    private static class RecordSupportedHelper extends RecordHelper {
        ...
        private RecordSupportedHelper() throws NoSuchMethodException, ClassNotFoundException {
            ...
            this.getRecordComponents = Class.class.getMethod("getRecordComponents", (Class[]) null);
            Class<?> cls = Class.forName("java.lang.reflect.RecordComponent");
            this.getName = cls.getMethod("getName", (Class[]) null);
            this.getType = cls.getMethod("getType", (Class[]) null);
        }
