...
public final class MediaType {
    ...
    public int hashCode() {
        ...
        int hashCode2 = Objects.hashCode(new Object[]{this.type, this.subtype, parametersAsMap()});
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            sb.append("; ");
            PARAMETER_JOINER.appendTo(sb, Multimaps.transformValues(this.parameters, new Function<String, String>() {
