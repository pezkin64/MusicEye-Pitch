...
class UArraysKt___UArraysJvmKt {
    ...
    public static /* synthetic */ int m473binarySearch2fe2U9s$default(int[] iArr, int i, int i2, int i3, int i4, Object obj) {
        ...
        if ((i4 & 4) != 0) {
            i3 = UIntArray.m161getSizeimpl(iArr);
        }
        return UArraysKt.m472binarySearch2fe2U9s(iArr, i, i2, i3);
    }

    /* renamed from: binarySearch-2fe2U9s  reason: not valid java name */
    public static final int m472binarySearch2fe2U9s(int[] iArr, int i, int i2, int i3) {
        Intrinsics.checkNotNullParameter(iArr, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i2, i3, UIntArray.m161getSizeimpl(iArr));
        int i4 = i3 - 1;
        while (i2 <= i4) {
            int i5 = (i2 + i4) >>> 1;
    ...
    public static final int m476binarySearchK6DWlUc(long[] jArr, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(jArr, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i, i2, ULongArray.m240getSizeimpl(jArr));
        int i3 = i2 - 1;
        while (i <= i3) {
            int i4 = (i + i3) >>> 1;
    ...
    public static final int m478binarySearchWpHrYlw(byte[] bArr, byte b, int i, int i2) {
        Intrinsics.checkNotNullParameter(bArr, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i, i2, UByteArray.m82getSizeimpl(bArr));
        byte b2 = b & 255;
        int i3 = i2 - 1;
        while (i <= i3) {
            int i4 = (i + i3) >>> 1;
    ...
    public static final int m474binarySearchEtDCXyQ(short[] sArr, short s, int i, int i2) {
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UInt m490maxByjgv0xPQ(int[] iArr, Function1<? super UInt, ? extends R> function1) {
        Intrinsics.checkNotNullParameter(iArr, "$this$maxBy");
        Intrinsics.checkNotNullParameter(function1, "selector");
        if (UIntArray.m163isEmptyimpl(iArr)) {
            return null;
        }
        int i = UIntArray.m160getpVg5ArA(iArr, 0);
        int lastIndex = ArraysKt.getLastIndex(iArr);
        if (lastIndex == 0) {
            return UInt.m94boximpl(i);
        }
        Comparable comparable = (Comparable) function1.invoke(UInt.m94boximpl(i));
        IntIterator it = new IntRange(1, lastIndex).iterator();
        while (it.hasNext()) {
            int i2 = UIntArray.m160getpVg5ArA(iArr, it.nextInt());
            Comparable comparable2 = (Comparable) function1.invoke(UInt.m94boximpl(i2));
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> ULong m489maxByMShoTSo(long[] jArr, Function1<? super ULong, ? extends R> function1) {
        Intrinsics.checkNotNullParameter(jArr, "$this$maxBy");
        Intrinsics.checkNotNullParameter(function1, "selector");
        if (ULongArray.m242isEmptyimpl(jArr)) {
            return null;
        }
        long j = ULongArray.m239getsVKNKU(jArr, 0);
        int lastIndex = ArraysKt.getLastIndex(jArr);
        if (lastIndex == 0) {
            return ULong.m173boximpl(j);
        }
        Comparable comparable = (Comparable) function1.invoke(ULong.m173boximpl(j));
        IntIterator it = new IntRange(1, lastIndex).iterator();
        while (it.hasNext()) {
            long j2 = ULongArray.m239getsVKNKU(jArr, it.nextInt());
            Comparable comparable2 = (Comparable) function1.invoke(ULong.m173boximpl(j2));
            if (comparable.compareTo(comparable2) < 0) {
                j = j2;
                comparable = comparable2;
            }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UByte m488maxByJOV_ifY(byte[] bArr, Function1<? super UByte, ? extends R> function1) {
        Intrinsics.checkNotNullParameter(bArr, "$this$maxBy");
        Intrinsics.checkNotNullParameter(function1, "selector");
        if (UByteArray.m84isEmptyimpl(bArr)) {
            return null;
        }
        byte b = UByteArray.m81getw2LRezQ(bArr, 0);
        int lastIndex = ArraysKt.getLastIndex(bArr);
        if (lastIndex == 0) {
            return UByte.m17boximpl(b);
        }
        Comparable comparable = (Comparable) function1.invoke(UByte.m17boximpl(b));
        IntIterator it = new IntRange(1, lastIndex).iterator();
        while (it.hasNext()) {
            byte b2 = UByteArray.m81getw2LRezQ(bArr, it.nextInt());
            Comparable comparable2 = (Comparable) function1.invoke(UByte.m17boximpl(b2));
            if (comparable.compareTo(comparable2) < 0) {
                b = b2;
                comparable = comparable2;
            }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UShort m491maxByxTcfx_M(short[] sArr, Function1<? super UShort, ? extends R> function1) {
        Intrinsics.checkNotNullParameter(sArr, "$this$maxBy");
        Intrinsics.checkNotNullParameter(function1, "selector");
        if (UShortArray.m347isEmptyimpl(sArr)) {
            return null;
        }
        short s = UShortArray.m344getMh2AYeg(sArr, 0);
        int lastIndex = ArraysKt.getLastIndex(sArr);
        if (lastIndex == 0) {
            return UShort.m280boximpl(s);
        }
        Comparable comparable = (Comparable) function1.invoke(UShort.m280boximpl(s));
        IntIterator it = new IntRange(1, lastIndex).iterator();
        while (it.hasNext()) {
            short s2 = UShortArray.m344getMh2AYeg(sArr, it.nextInt());
            Comparable comparable2 = (Comparable) function1.invoke(UShort.m280boximpl(s2));
            if (comparable.compareTo(comparable2) < 0) {
                s = s2;
                comparable = comparable2;
            }
    ...
    public static final /* synthetic */ UInt m493maxWithYmdZ_VM(int[] iArr, Comparator comparator) {
        Intrinsics.checkNotNullParameter(iArr, "$this$maxWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m861maxWithOrNullYmdZ_VM(iArr, comparator);
    }

    @Deprecated(message = "Use maxWithOrNull instead.", replaceWith = @ReplaceWith(expression = "this.maxWithOrNull(comparator)", imports = {}))
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: maxWith-zrEWJaI  reason: not valid java name */
    public static final /* synthetic */ ULong m495maxWithzrEWJaI(long[] jArr, Comparator comparator) {
        Intrinsics.checkNotNullParameter(jArr, "$this$maxWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m863maxWithOrNullzrEWJaI(jArr, comparator);
    }

    @Deprecated(message = "Use maxWithOrNull instead.", replaceWith = @ReplaceWith(expression = "this.maxWithOrNull(comparator)", imports = {}))
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: maxWith-XMRcp5o  reason: not valid java name */
    public static final /* synthetic */ UByte m492maxWithXMRcp5o(byte[] bArr, Comparator comparator) {
        Intrinsics.checkNotNullParameter(bArr, "$this$maxWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m860maxWithOrNullXMRcp5o(bArr, comparator);
    }

    @Deprecated(message = "Use maxWithOrNull instead.", replaceWith = @ReplaceWith(expression = "this.maxWithOrNull(comparator)", imports = {}))
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: maxWith-eOHTfZs  reason: not valid java name */
    public static final /* synthetic */ UShort m494maxWitheOHTfZs(short[] sArr, Comparator comparator) {
        Intrinsics.checkNotNullParameter(sArr, "$this$maxWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m862maxWithOrNulleOHTfZs(sArr, comparator);
    }

    @Deprecated(message = "Use minByOrNull instead.", replaceWith = @ReplaceWith(expression = "this.minByOrNull(selector)", imports = {}))
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: minBy-jgv0xPQ  reason: not valid java name */
    private static final /* synthetic */ <R extends Comparable<? super R>> UInt m502minByjgv0xPQ(int[] iArr, Function1<? super UInt, ? extends R> function1) {
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> ULong m501minByMShoTSo(long[] jArr, Function1<? super ULong, ? extends R> function1) {
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UByte m500minByJOV_ifY(byte[] bArr, Function1<? super UByte, ? extends R> function1) {
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UShort m503minByxTcfx_M(short[] sArr, Function1<? super UShort, ? extends R> function1) {
    ...
    public static final /* synthetic */ UInt m505minWithYmdZ_VM(int[] iArr, Comparator comparator) {
        Intrinsics.checkNotNullParameter(iArr, "$this$minWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m917minWithOrNullYmdZ_VM(iArr, comparator);
    }

    @Deprecated(message = "Use minWithOrNull instead.", replaceWith = @ReplaceWith(expression = "this.minWithOrNull(comparator)", imports = {}))
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: minWith-zrEWJaI  reason: not valid java name */
    public static final /* synthetic */ ULong m507minWithzrEWJaI(long[] jArr, Comparator comparator) {
        Intrinsics.checkNotNullParameter(jArr, "$this$minWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m919minWithOrNullzrEWJaI(jArr, comparator);
    }

    @Deprecated(message = "Use minWithOrNull instead.", replaceWith = @ReplaceWith(expression = "this.minWithOrNull(comparator)", imports = {}))
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: minWith-XMRcp5o  reason: not valid java name */
    public static final /* synthetic */ UByte m504minWithXMRcp5o(byte[] bArr, Comparator comparator) {
        Intrinsics.checkNotNullParameter(bArr, "$this$minWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m916minWithOrNullXMRcp5o(bArr, comparator);
    }

    @Deprecated(message = "Use minWithOrNull instead.", replaceWith = @ReplaceWith(expression = "this.minWithOrNull(comparator)", imports = {}))
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: minWith-eOHTfZs  reason: not valid java name */
    public static final /* synthetic */ UShort m506minWitheOHTfZs(short[] sArr, Comparator comparator) {
        Intrinsics.checkNotNullParameter(sArr, "$this$minWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m918minWithOrNulleOHTfZs(sArr, comparator);
    }
    ...
    private static final BigDecimal sumOfBigDecimal(int[] iArr, Function1<? super UInt, ? extends BigDecimal> function1) {
        ...
        int r1 = UIntArray.m161getSizeimpl(iArr);
        for (int i = 0; i < r1; i++) {
            valueOf = valueOf.add((BigDecimal) function1.invoke(UInt.m94boximpl(UIntArray.m160getpVg5ArA(iArr, i))));
    ...
    private static final BigDecimal sumOfBigDecimal(long[] jArr, Function1<? super ULong, ? extends BigDecimal> function1) {
        ...
        BigDecimal valueOf = BigDecimal.valueOf(0);
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(this.toLong())");
        int r1 = ULongArray.m240getSizeimpl(jArr);
        for (int i = 0; i < r1; i++) {
            valueOf = valueOf.add((BigDecimal) function1.invoke(ULong.m173boximpl(ULongArray.m239getsVKNKU(jArr, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(byte[] bArr, Function1<? super UByte, ? extends BigDecimal> function1) {
        ...
        BigDecimal valueOf = BigDecimal.valueOf(0);
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(this.toLong())");
        int r1 = UByteArray.m82getSizeimpl(bArr);
        for (int i = 0; i < r1; i++) {
            valueOf = valueOf.add((BigDecimal) function1.invoke(UByte.m17boximpl(UByteArray.m81getw2LRezQ(bArr, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(short[] sArr, Function1<? super UShort, ? extends BigDecimal> function1) {
        ...
        for (int i = 0; i < r1; i++) {
            valueOf = valueOf.add((BigDecimal) function1.invoke(UShort.m280boximpl(UShortArray.m344getMh2AYeg(sArr, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(int[] iArr, Function1<? super UInt, ? extends BigInteger> function1) {
        ...
        int r1 = UIntArray.m161getSizeimpl(iArr);
        for (int i = 0; i < r1; i++) {
            valueOf = valueOf.add((BigInteger) function1.invoke(UInt.m94boximpl(UIntArray.m160getpVg5ArA(iArr, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(long[] jArr, Function1<? super ULong, ? extends BigInteger> function1) {
        ...
        int r1 = ULongArray.m240getSizeimpl(jArr);
        for (int i = 0; i < r1; i++) {
            valueOf = valueOf.add((BigInteger) function1.invoke(ULong.m173boximpl(ULongArray.m239getsVKNKU(jArr, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(byte[] bArr, Function1<? super UByte, ? extends BigInteger> function1) {
        ...
        int r1 = UByteArray.m82getSizeimpl(bArr);
        for (int i = 0; i < r1; i++) {
            valueOf = valueOf.add((BigInteger) function1.invoke(UByte.m17boximpl(UByteArray.m81getw2LRezQ(bArr, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(short[] sArr, Function1<? super UShort, ? extends BigInteger> function1) {
        ...
        int r1 = UShortArray.m345getSizeimpl(sArr);
        for (int i = 0; i < r1; i++) {
            valueOf = valueOf.add((BigInteger) function1.invoke(UShort.m280boximpl(UShortArray.m344getMh2AYeg(sArr, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
