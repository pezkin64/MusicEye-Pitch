...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        if (j3 == 0) {
            ...
            this.first = j;
            this.last = UProgressionUtilKt.m1208getProgressionLastElement7ftBX0g(j, j2, j3);
            this.step = j3;
        } else {
    ...
    public boolean isEmpty() {
        ...
        long j = this.first;
        long j2 = this.last;
        return i > 0 ? UByte$$ExternalSyntheticBackport0.m(j, j2) > 0 : UByte$$ExternalSyntheticBackport0.m(j, j2) < 0;
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return (((((int) ULong.m179constructorimpl(j ^ ULong.m179constructorimpl(j >>> 32))) * 31) + ((int) ULong.m179constructorimpl(j2 ^ ULong.m179constructorimpl(j2 >>> 32)))) * 31) + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m225toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m225toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1234fromClosedRange7ftBX0g(long j, long j2, long j3) {
