...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        boolean z = true;
        if (i3 <= 0 ? Integer.compare(i ^ IntCompanionObject.MIN_VALUE, i2 ^ IntCompanionObject.MIN_VALUE) < 0 : Integer.compare(i ^ IntCompanionObject.MIN_VALUE, i2 ^ IntCompanionObject.MIN_VALUE) > 0) {
            z = false;
        }
        this.hasNext = z;
        this.step = UInt.m100constructorimpl(i3);
        this.next = !this.hasNext ? i2 : i;
    }

    public /* bridge */ /* synthetic */ Object next() {
        return UInt.m94boximpl(m1226nextpVg5ArA());
    }
    ...
    public int m1226nextpVg5ArA() {
        int i = this.next;
        if (i != this.finalElement) {
            this.next = UInt.m100constructorimpl(this.step + i);
            return i;
