    ...
    public final int encodeIntoByteArrayImpl$kotlin_stdlib(byte[] bArr, byte[] bArr2, int i, int i2, int i3) {
        ...
        while (i5 + 2 < i6) {
            ...
            for (int i9 = 0; i9 < min; i9++) {
                ...
                bArr4[i8 + 1] = access$getBase64UrlEncodeMap$p[(b >>> ConstantPoolEntry.CP_NameAndType) & 63];
                int i11 = i8 + 3;
    ...
    private final int decodeImpl(byte[] bArr, byte[] bArr2, int i, int i2, int i3) {
        ...
        while (true) {
            ...
            if (i9 != i7 || i11 + 3 >= i6) {
                ...
                int i12 = i11 + 4;
                i5 = 1;
                int i13 = (access$getBase64UrlDecodeMap$p[bArr3[i11] & 255] << 18) | (access$getBase64UrlDecodeMap$p[bArr3[i11 + 1] & 255] << 12) | (access$getBase64UrlDecodeMap$p[bArr3[i11 + 2] & 255] << 6) | access$getBase64UrlDecodeMap$p[bArr3[i11 + 3] & 255];
                if (i13 >= 0) {
            ...
            int i15 = access$getBase64UrlDecodeMap$p[b];
            if (i15 >= 0) {
                i11++;
                i10 = (i10 << 6) | i15;
                int i16 = i9 + 6;
                if (i16 >= 0) {
                    bArr2[i8] = (byte) (i10 >>> i16);
                    i10 &= (i5 << i16) - 1;
                    i9 -= 2;
                    i8++;
                } else {
                ...
                i11 = handlePaddingSymbol(bArr3, i11, i6, i9);
                break;
        ...
        if (i9 != -2) {
            int skipIllegalSymbolsIfMime = skipIllegalSymbolsIfMime(bArr3, i11, i6);
