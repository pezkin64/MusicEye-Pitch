...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final Path copyToRecursively(Path path, Path path2, Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> function3, boolean z, Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> function32) {
        ...
        if (Files.exists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            boolean z2 = false;
            if (Files.exists(path, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && (z || !PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(path))) {
                boolean z3 = Files.exists(path2, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && !PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(path2);
                if (!z3 || !PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, path2)) {
                    if (Intrinsics.areEqual((Object) PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path), (Object) PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path2))) {
                        if (z3) {
                            ...
                            Path m$1 = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(path2);
                            if (m$1 != null && Files.exists(m$1, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(m$1, new LinkOption[0]), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, new LinkOption[0]))) {
                                z2 = true;
                            }
                        }
                    }
    ...
    private static final java.util.List<java.lang.Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(java.nio.file.Path r8) {
        ...
        L_0x0014:
            ...
            java.nio.file.DirectoryStream r6 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r5)     // Catch:{ all -> 0x003e }
            boolean r7 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r6)     // Catch:{ all -> 0x003e }
            if (r7 == 0) goto L_0x0036
            r0.setPath(r4)     // Catch:{ all -> 0x003e }
            java.nio.file.SecureDirectoryStream r2 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r6)     // Catch:{ all -> 0x003e }
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(java.nio.file.SecureDirectoryStream<java.nio.file.Path> r4, java.nio.file.Path r5, kotlin.io.path.ExceptionsCollector r6) {
        ...
        L_0x0013:
            ...
            java.nio.file.SecureDirectoryStream r5 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r4)     // Catch:{ all -> 0x0040 }
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(java.nio.file.Path r4, kotlin.io.path.ExceptionsCollector r5) {
        ...
        L_0x0009:
            ...
            java.nio.file.DirectoryStream r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r4)     // Catch:{ all -> 0x0032 }
