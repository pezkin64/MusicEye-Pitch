...
public final class UMathKt {
    ...
    private static final int m1212minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1194minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m1213mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1202minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m1210maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1182maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m1211maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1190maxOfeb3DHEI(j, j2);
    }
}
