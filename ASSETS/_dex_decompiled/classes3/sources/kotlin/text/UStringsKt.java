...
public final class UStringsKt {
    ...
    public static final String m1309toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1311toStringolVBNx4(short s, int i) {
    ...
    public static final String m1310toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1308toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m152unboximpl();
        if (Integer.compare(r1 ^ IntCompanionObject.MIN_VALUE, UInt.m100constructorimpl(255) ^ IntCompanionObject.MIN_VALUE) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m152unboximpl();
        if (Integer.compare(r1 ^ IntCompanionObject.MIN_VALUE, UInt.m100constructorimpl(65535) ^ IntCompanionObject.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m280boximpl(UShort.m286constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m100constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ IntCompanionObject.MIN_VALUE, i4 ^ IntCompanionObject.MIN_VALUE) > 0) {
                if (i4 == 119304647) {
            ...
            int r2 = UInt.m100constructorimpl(i3 * r3);
            int r7 = UInt.m100constructorimpl(UInt.m100constructorimpl(digitOf) + r2);
            if (Integer.compare(r7 ^ IntCompanionObject.MIN_VALUE, r2 ^ IntCompanionObject.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = r7;
        }
        return UInt.m94boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m179constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            long r9 = ULong.m179constructorimpl(j * r5);
            long r13 = ULong.m179constructorimpl(ULong.m179constructorimpl(((long) UInt.m100constructorimpl(digitOf)) & 4294967295L) + r9);
