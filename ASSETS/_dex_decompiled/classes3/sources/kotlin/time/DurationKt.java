...
public final class DurationKt {
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        if (length != 0) {
            long r72 = Duration.Companion.m1439getZEROUwyO8pc();
            ...
            if (length > i3) {
                ...
                if (str2.charAt(i3) == 'P') {
                                ...
                                if (charSequence.length() != 0) {
                                    ...
                                    if (durationUnit == null || durationUnit.compareTo(durationUnitByIsoChar) > 0) {
                                        ...
                                        if (durationUnitByIsoChar != DurationUnit.SECONDS || indexOf$default <= 0) {
                                            r72 = Duration.m1372plusLRDsOJo(r72, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                                        } else {
                                            Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                                            String substring2 = substring.substring(0, indexOf$default);
                                            Intrinsics.checkNotNullExpressionValue(substring2, "this as java.lang.String…ing(startIndex, endIndex)");
                                            long r73 = Duration.m1372plusLRDsOJo(r72, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                                            Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                                            String substring3 = substring.substring(indexOf$default);
                                            Intrinsics.checkNotNullExpressionValue(substring3, "this as java.lang.String).substring(startIndex)");
                                            r72 = Duration.m1372plusLRDsOJo(r73, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                                        }
                    ...
                    if (!z) {
                        ...
                        char c3 = '0';
                        if (StringsKt.regionMatches(str2, i3, "Infinity", 0, Math.max(i6 - i3, 8), true)) {
                            r72 = Duration.Companion.m1437getINFINITEUwyO8pc();
                        } else {
                            boolean z8 = !z5;
                                ...
                                if (charSequence3.length() != 0) {
                                    ...
                                    if (durationUnit2 == null || durationUnit2.compareTo(durationUnitByShortName) > 0) {
                                        ...
                                        if (indexOf$default2 > 0) {
                                            ...
                                            long r74 = Duration.m1372plusLRDsOJo(r72, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                                            Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                                            String substring7 = substring4.substring(indexOf$default2);
                                            Intrinsics.checkNotNullExpressionValue(substring7, "this as java.lang.String).substring(startIndex)");
                                            r7 = Duration.m1372plusLRDsOJo(r74, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                                            if (i3 < i) {
                                                throw new IllegalArgumentException("Fractional component must be last");
                                            }
                                        } else {
                                            r7 = Duration.m1372plusLRDsOJo(r72, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                                        }
                ...
                if (z2) {
                    return Duration.m1389unaryMinusUwyO8pc(r72);
                }
                return r72;
            }
            throw new IllegalArgumentException("No components");
    ...
    public static final long durationOf(long j, int i) {
        return Duration.m1336constructorimpl((j << 1) + ((long) i));
    }
