...
public abstract class AbstractLongTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class LongTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark m1320minusLRDsOJo(long j) {
            return ComparableTimeMark.DefaultImpls.m1331minusLRDsOJo(this, j);
        }

        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long m1318elapsedNowUwyO8pc() {
        ...
        public ComparableTimeMark m1323plusLRDsOJo(long j) {
            DurationUnit unit = this.timeSource.getUnit();
            if (Duration.m1368isInfiniteimpl(j)) {
                return new LongTimeMark(LongSaturatedMathKt.m1465saturatingAddNuflL3o(this.startedAt, unit, j), this.timeSource, Duration.Companion.m1439getZEROUwyO8pc(), (DefaultConstructorMarker) null);
            }
            long r1 = Duration.m1388truncateToUwyO8pc$kotlin_stdlib(j, unit);
            long r11 = Duration.m1372plusLRDsOJo(Duration.m1371minusLRDsOJo(j, r1), this.offset);
            long r12 = LongSaturatedMathKt.m1465saturatingAddNuflL3o(this.startedAt, unit, r1);
            long r3 = Duration.m1388truncateToUwyO8pc$kotlin_stdlib(r11, unit);
            long r13 = LongSaturatedMathKt.m1465saturatingAddNuflL3o(r12, unit, r3);
            long r112 = Duration.m1371minusLRDsOJo(r11, r3);
            long r32 = Duration.m1356getInWholeNanosecondsimpl(r112);
            if (!(r13 == 0 || r32 == 0 || (r13 ^ r32) >= 0)) {
                long duration = DurationKt.toDuration(MathKt.getSign(r32), unit);
                r13 = LongSaturatedMathKt.m1465saturatingAddNuflL3o(r13, unit, duration);
                r112 = Duration.m1371minusLRDsOJo(r112, duration);
            }
            if ((1 | (r13 - 1)) == LongCompanionObject.MAX_VALUE) {
                r112 = Duration.Companion.m1439getZEROUwyO8pc();
            }
            return new LongTimeMark(r13, this.timeSource, r112, (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-UwyO8pc  reason: not valid java name */
        public long m1321minusUwyO8pc(ComparableTimeMark comparableTimeMark) {
        ...
        public boolean equals(Object obj) {
            return (obj instanceof LongTimeMark) && Intrinsics.areEqual((Object) this.timeSource, (Object) ((LongTimeMark) obj).timeSource) && Duration.m1341equalsimpl0(m1321minusUwyO8pc((ComparableTimeMark) obj), Duration.Companion.m1439getZEROUwyO8pc());
        }

        public int hashCode() {
            return (Duration.m1364hashCodeimpl(this.offset) * 37) + UByte$$ExternalSyntheticBackport0.m(this.startedAt);
        }

        public String toString() {
            return "LongTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + Duration.m1385toStringimpl(this.offset) + ", " + this.timeSource + ')';
        }
    }

    public ComparableTimeMark markNow() {
        return new LongTimeMark(adjustedRead(), this, Duration.Companion.m1439getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
