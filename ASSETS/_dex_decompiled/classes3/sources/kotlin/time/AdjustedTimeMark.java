...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m1325getAdjustmentUwyO8pc() {
    ...
    public TimeMark m1326minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1476minusLRDsOJo(this, j);
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    public long m1324elapsedNowUwyO8pc() {
        return Duration.m1371minusLRDsOJo(this.mark.m1473elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1327plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1372plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
