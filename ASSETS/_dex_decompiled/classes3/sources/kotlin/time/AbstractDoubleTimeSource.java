...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark m1314minusLRDsOJo(long j) {
            return ComparableTimeMark.DefaultImpls.m1331minusLRDsOJo(this, j);
        }

        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long m1312elapsedNowUwyO8pc() {
        ...
        public ComparableTimeMark m1317plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1372plusLRDsOJo(this.offset, j), (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-UwyO8pc  reason: not valid java name */
        public long m1315minusUwyO8pc(ComparableTimeMark comparableTimeMark) {
            ...
            if (comparableTimeMark instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual((Object) this.timeSource, (Object) doubleTimeMark.timeSource)) {
                    if (Duration.m1341equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m1368isInfiniteimpl(this.offset)) {
                        return Duration.Companion.m1439getZEROUwyO8pc();
                    }
                    long r2 = Duration.m1371minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return Duration.m1341equalsimpl0(duration, Duration.m1389unaryMinusUwyO8pc(r2)) ? Duration.Companion.m1439getZEROUwyO8pc() : Duration.m1372plusLRDsOJo(duration, r2);
                }
            }
        ...
        public boolean equals(Object obj) {
            return (obj instanceof DoubleTimeMark) && Intrinsics.areEqual((Object) this.timeSource, (Object) ((DoubleTimeMark) obj).timeSource) && Duration.m1341equalsimpl0(m1315minusUwyO8pc((ComparableTimeMark) obj), Duration.Companion.m1439getZEROUwyO8pc());
        }

        public int hashCode() {
            return Duration.m1364hashCodeimpl(Duration.m1372plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + Duration.m1385toStringimpl(this.offset) + ", " + this.timeSource + ')';
        }
    }
