...
public class DumpArchiveEntry implements ArchiveEntry {
    ...
    static DumpArchiveEntry parse(byte[] bArr) {
        ...
        dumpArchiveEntry.setUserId(DumpArchiveUtil.convert32(bArr, ShortMessage.NOTE_ON));
        dumpArchiveEntry.setGroupId(DumpArchiveUtil.convert32(bArr, TarConstants.CHKSUM_OFFSET));
        int unused3 = tapeSegmentHeader.count = DumpArchiveUtil.convert32(bArr, ShortMessage.POLY_PRESSURE);
    ...
    public void update(byte[] bArr) {
        ...
        int unused2 = this.header.count = DumpArchiveUtil.convert32(bArr, ShortMessage.POLY_PRESSURE);
