...
public class SnappyCompressorOutputStream extends CompressorOutputStream {
    ...
    public /* synthetic */ void m1590lambda$new$0$orgapachecommonscompresscompressorssnappySnappyCompressorOutputStream(LZ77Compressor.Block block) throws IOException {
    ...
    private void writeLiteralBlock(LZ77Compressor.LiteralBlock literalBlock) throws IOException {
        ...
        } else if (length <= MAX_LITERAL_SIZE_WITH_THREE_SIZE_BYTES) {
