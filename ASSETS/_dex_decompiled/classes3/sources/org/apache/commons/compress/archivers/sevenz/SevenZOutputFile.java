...
public class SevenZOutputFile implements Closeable {
    ...
    public SevenZOutputFile(File file) throws IOException {
        this(Files.newByteChannel(file.toPath(), EnumSet.of(StreamsKt$$ExternalSyntheticApiModelOutline0.m$1(), StreamsKt$$ExternalSyntheticApiModelOutline0.m(), StreamsKt$$ExternalSyntheticApiModelOutline0.m$2()), new FileAttribute[0]));
    }
    ...
    public SevenZArchiveEntry createArchiveEntry(Path path, String str, LinkOption... linkOptionArr) throws IOException {
        SevenZArchiveEntry sevenZArchiveEntry = new SevenZArchiveEntry();
        sevenZArchiveEntry.setDirectory(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, linkOptionArr));
        sevenZArchiveEntry.setName(str);
        sevenZArchiveEntry.setLastModifiedDate(new Date(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, linkOptionArr).toMillis()));
        return sevenZArchiveEntry;
    }
    ...
    public void write(java.nio.file.Path r2, java.nio.file.OpenOption... r3) throws java.io.IOException {
        /*
            ...
            java.io.InputStream r2 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r2, (java.nio.file.OpenOption[]) r3)
            r0.<init>(r2)
