...
public class CpioArchiveEntry implements CpioConstants, ArchiveEntry {
    ...
    public CpioArchiveEntry(short s, Path path, String str, LinkOption... linkOptionArr) throws IOException {
        this(s, str, Files.isRegularFile(path, linkOptionArr) ? PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path) : 0);
        ...
        setTime(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, linkOptionArr));
    }
