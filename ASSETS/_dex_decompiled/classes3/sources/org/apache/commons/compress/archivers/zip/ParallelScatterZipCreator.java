...
public class ParallelScatterZipCreator {
    ...
    public /* synthetic */ ScatterZipOutputStream m1587lambda$submit$0$orgapachecommonscompressarchiverszipParallelScatterZipCreator(Callable callable) throws Exception {
        callable.call();
    ...
    public /* synthetic */ ScatterZipOutputStream m1585lambda$createCallable$1$orgapachecommonscompressarchiverszipParallelScatterZipCreator(ZipArchiveEntryRequest zipArchiveEntryRequest) throws Exception {
    ...
    public /* synthetic */ ScatterZipOutputStream m1586lambda$createCallable$2$orgapachecommonscompressarchiverszipParallelScatterZipCreator(ZipArchiveEntryRequestSupplier zipArchiveEntryRequestSupplier) throws Exception {
        ScatterZipOutputStream scatterZipOutputStream = this.tlScatterStreams.get();
