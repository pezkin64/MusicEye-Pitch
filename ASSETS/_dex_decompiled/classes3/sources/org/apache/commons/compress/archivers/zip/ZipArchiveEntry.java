...
public class ZipArchiveEntry extends ZipEntry implements ArchiveEntry, EntryStreamOffsets {
    ...
    public ZipArchiveEntry(java.nio.file.Path r3, java.lang.String r4, java.nio.file.LinkOption... r5) throws java.io.IOException {
        /*
            r2 = this;
            boolean r0 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r3, (java.nio.file.LinkOption[]) r5)
            if (r0 == 0) goto L_0x001d
            java.lang.String r0 = "/"
            boolean r1 = r4.endsWith(r0)
            if (r1 != 0) goto L_0x001d
        ...
        L_0x001d:
            ...
            if (r4 == 0) goto L_0x002d
            long r0 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r3)
            r2.setSize(r0)
        L_0x002d:
            java.nio.file.attribute.FileTime r3 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r3, (java.nio.file.LinkOption[]) r5)
            r2.setTime(r3)
            return
        */
