...
public class SegmentHeader extends BandSet {
    ...
    private static final int[] magic = {202, ShortMessage.ACTIVE_SENSING, ShortMessage.CHANNEL_PRESSURE, 13};
    ...
    public void pack(OutputStream outputStream) throws IOException, Pack200Exception {
        ...
        outputStream.write(encodeScalar((int) archive_majver, Codec.UNSIGNED5));
    ...
    private void calculateArchiveOptions() {
        ...
        this.archive_options = i | ShortMessage.PROGRAM_CHANGE;
